...
export function sendRegistrationEmail({
  ...
  <div style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; max-width: 700px; margin: 0 auto;">
      ...
      <div style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; border-radius: 4px; font-size: 1rem; line-height: 1.5; position: relative; margin: 1rem 0em; padding: 1.5em; border: 1px solid #c0c0c0;">
          ...
          <p style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; line-height: 1.4285em; font-size: 1rem; color: rgba(0,0,0,0.87); margin: 0 0 1em;">
              Terima kasih banget udah ikutan <strong style="font-weight: bolder; box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif;">Kudoku</strong> waiting list!
          </p>
          ...
          <p style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; line-height: 1.4285em; font-size: 1rem; color: rgba(0,0,0,0.87); margin: 0 0 1em;">
              Oiya, kita juga lagi bangun community bareng semua user Kudoku pake <strong style="font-weight: bolder; box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif;">Discord</strong> nih. Lo bisa join <a href="${DISCORD}" style="background-color: transparent; box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; color: #4183c4; text-decoration: none;" rel="nofollow">disini</a>.
          </p>
          ...
          <p style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; line-height: 1.4285em; font-size: 1rem; color: rgba(0,0,0,0.87); margin: 0 0 1em;">
              Anyway, lo pasti sekarang lagi ngisi form selanjutnya. Kudoku appreciate bgt kalo lo nyelesain formnya. Tapi kalo lo mau ngisinya nanti, ini gua kasih linknya:
          </p>
      
          <div style="box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; padding: 1em;" align="center">
              <a href="${FORMLINK}" style="background-color: #2C5EA8; box-sizing: inherit; font-family: Avenir, Helvetica, Arial, sans-serif; color: white; text-decoration: none; font-weight: bold; display: inline-block; cursor: pointer; line-height: 1em; text-align: center; border-radius: 6px; padding: 13px 27px;" rel="nofollow">
                  Lanjutin Form
              </a>
          </div>
...
export function sendAlreadyRegisteredEmail({
  id,
  firstName,
  lastName,
  email,
